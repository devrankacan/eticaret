    ...
    <>
      ...
      {settings.site_whatsapp && (
        <a
          ...
          className="fixed bottom-20 right-4 z-40 bg-green-500 hover:bg-green-600 text-white w-14 h-14 rounded-full flex items-center justify-center shadow-xl transition hover:scale-110"
          aria-label="WhatsApp"
        >
